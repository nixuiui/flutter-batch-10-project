...
// in flutter_batch_10_project/test/auth_remote_data_test.dart.
...
class _FakeAuthLocalStorage_1 extends _i1.SmartFake
  ...
  _FakeAuthLocalStorage_1(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
class MockNetworkService extends _i1.Mock implements _i4.NetworkService {
  ...
  @override
  _i3.AuthLocalStorage get authStorage =>
      (super.noSuchMethod(
  ...
  set authStorage(_i3.AuthLocalStorage? _authStorage) => super.noSuchMethod(
    Invocation.setter(#authStorage, _authStorage),
    returnValueForMissingStub: null,
  );

  @override
  _i5.Future<Map<String, dynamic>> headersRequest() =>
      (super.noSuchMethod(
            Invocation.method(#headersRequest, []),
